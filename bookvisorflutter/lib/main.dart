...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme : ThemeData(
        fontFamily: 'Cairo',
        textTheme : Theme.of(context).textTheme.apply(displayColor: Color(0XFF222B45)), // kTextColor
      ),
      home:   MyHomePage(),
    );
  }
...
class MyHomePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size; // gives the total height and width of our page
    return Scaffold(
      body: Stack(
      children :  <Widget> [
